...
//            }
//
//            self!.db.collection("muridClass").getDocuments(completion: { [weak self] (querySnapshot, error) in
//                guard let muridClassDocuments = querySnapshot?.documents else {
//                    print("error nie gyan")
//                    return
//                }
//
//                //filtered out the same classid
//                let muridClassId = Set(muridClassDocuments.compactMap { $0.data()["classid"] as? String })
//
...
//                        }
//
//                        // Check if the classid exists in muridClass collection
//                        if muridClassId.contains(classid) {
//                            continue
//                        }
//
//                        let eachClass = Class(className: className, classDesc: classDesc, classModule: classModule, classEnrollment: classEnrollment, classImg: classImg, classImgString: imgURL, classid: classid)
